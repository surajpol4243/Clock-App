import {
    ...
    REQUEST_SET_USER_DATA, RECEIVE_SET_USER_DATA,
    REQUEST_ADD_ALARM, RECEIVE_ADD_ALARM,
    REQUEST_REMOVE_ALARM, RECEIVE_REMOVE_ALARM
} from "../actionTypes/commonActionType";

// create common action creator method here

// time zone list action creator
